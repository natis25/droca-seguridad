    ...
    <div class="container">
        ...
        <nav id="nav" class="collapse navbar-collapse">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="btn btn-outline-primary ms-2" href="login.php">Iniciar Sesión</a></li>
            </ul>
        </nav>
    </div>
</header>
...
<main class="container my-5" style="max-width:880px">
    <div class="card card-lite p-4 p-md-5 mx-auto shadow-sm">
        ...
        <?php if (!empty($_SESSION['flash_error'])): ?>
            <div class="alert alert-danger"><strong>Error:</strong> <?= htmlspecialchars($_SESSION['flash_error']) ?></div>
        ...
        <div class="alert alert-info d-flex align-items-center gap-2 small">
            <div>
                Registra tus datos tal como aparecen en tu documento. El <strong>usuario</strong> se generará automáticamente.
            </div>
        </div>
        ...
        <form method="post" action="Logica/procesarRegistroCliente.php" novalidate autocomplete="off">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input name="nombre" maxlength="100" class="form-control" placeholder="Ej.: Juan Carlos" required autocomplete="given-name">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Primer Apellido</label>
                    <input name="apellido" maxlength="100" class="form-control" placeholder="Ej.: Pérez" required autocomplete="family-name">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Segundo Apellido</label>
                    <input name="apellido2" maxlength="100" class="form-control" placeholder="Ej.: Gómez" required autocomplete="additional-name">
                </div>

                <div class="col-12">
                    <label class="form-label">Usuario (Automático)</label>
                    <input name="usuario" id="usuario" class="form-control bg-light" readonly placeholder="Se generará al escribir nombre..." tabindex="-1">
                </div>

                <div class="col-md-6">
                    <label class="form-label">Correo Electrónico</label>
                    <input name="correo" type="email" maxlength="100" class="form-control" placeholder="nombre@ejemplo.com" required autocomplete="email">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Teléfono</label>
                    <input name="telefono" pattern="\d{8}" maxlength="8" class="form-control" placeholder="12345678" required inputmode="numeric">
                ...
                <div class="col-12">
                    ...
                    <input name="password2" id="password2" type="password" class="form-control" placeholder="Repite la contraseña" required>
                    <div id="match-feedback" class="form-text text-danger d-none">Las contraseñas no coinciden.</div>
                </div>
